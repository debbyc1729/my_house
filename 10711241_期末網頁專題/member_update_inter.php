...
<form onsubmit="alert('表單送出');" method="post" action="member_update_inter2.php" enctype="multipart/form-data">
...
$row=$rs->fetch();
	echo "新增自我介紹：<br><textarea type=text name=inter value=" . $row['inter'] . "></textarea>";
